...
#args setting here
model_name_a = ['iql','iql_op','t3r02','vdn','vdn_op','t3r02','vdn_sad_aux','vdn_sad_aux_op','t3r02']
model_name_b = [11111,11111,11111,1,1,1,111,1111,111]
model_name_c = ['ssd','ssdop','t3r02']
device = 'cuda:0'
agent_a_set = []
agent_b_set = []

exp_name = "ssd_models_cp"
...
for type_idx in range(3):
    for seed_idx in range(1,11):
        name = model_name_c[type_idx]+'_seed'+str(seed_idx*111111)
        agent_a_set.append(name)

for type_idx in range(9):
    for seed_idx in range(1,11):
